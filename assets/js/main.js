...
$(".icon-right-open").click(function () {
  ...
  if (isVideo(nextMediaSrc)) {
    modalBody.html(
      '<video controls style="width: 100%; height: auto;"><source src="' +
        nextMediaSrc +
        '" type="video/mp4"></video>'
    )
  } else {
    modalBody.html(
      '<img src="' + nextMediaSrc + '" style="width: 100%; height: auto;">'
    )
  }
...
$(".icon-left-open").click(function () {
  ...
  if (isVideo(prevMediaSrc)) {
    ...
    modalBody.html(
      '<img src="' + prevMediaSrc + '" style="width: 100%; height: auto;">'
    )
  }
...
function isVideo(fileSrc) {
  return (
    ...
    fileSrc.toLowerCase().endsWith(".webm") ||
    fileSrc.toLowerCase().endsWith(".ogg")
  )
}
...
function toggleDropdown() {
  var dropdownContent = document.getElementById("myCustomDropdown")
